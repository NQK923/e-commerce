...
public class CouponRepositoryImpl implements CouponRepository {
    ...
    public Coupon save(Coupon coupon) {
        return toDomain(jpaRepository.save(Objects.requireNonNull(toEntity(coupon))));
    }
    ...
    public Optional<Coupon> findByCode(String code) {
        return jpaRepository.findByCode(Objects.requireNonNull(code)).map(this::toDomain);
    }

    @Override
    public List<Coupon> findBySellerId(String sellerId) {
        return jpaRepository.findBySellerId(Objects.requireNonNull(sellerId)).stream().map(this::toDomain)
    ...
    private CouponEntity toEntity(Coupon domain) {
        return CouponEntity.builder()
                ...
                .maxDiscountAmount(
                        domain.getMaxDiscountAmount() != null ? domain.getMaxDiscountAmount().getAmount() : null)
                .maxDiscountCurrency(
                        domain.getMaxDiscountAmount() != null ? domain.getMaxDiscountAmount().getCurrency() : null)
    ...
    private Coupon toDomain(CouponEntity entity) {
        return Coupon.builder()
                ...
                .minOrderValue(entity.getMinOrderAmount() != null
                        ? Money.builder().amount(entity.getMinOrderAmount()).currency(entity.getMinOrderCurrency())
                                .build()
                        : null)
                .maxDiscountAmount(entity.getMaxDiscountAmount() != null
                        ? Money.builder().amount(entity.getMaxDiscountAmount())
                                .currency(entity.getMaxDiscountCurrency()).build()
                        : null)
