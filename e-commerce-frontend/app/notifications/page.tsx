...
export default function NotificationsPage() {
  ...
  if (!user) {
    return <div className="container mx-auto max-w-3xl py-10 text-center text-zinc-600">Vui lòng đăng nhập để xem thông báo.</div>;
  }
  ...
  return (
    <div className="container mx-auto max-w-3xl py-8 px-4 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button variant="outline" size="sm" onClick={() => void refresh()}>Làm mới</Button>
      </div>
      ...
      <div className="bg-white border border-zinc-200 rounded-xl shadow-sm divide-y divide-zinc-100">
        {loading ? (
          ...
          <div className="p-6 text-center text-sm text-zinc-500">Chưa có thông báo</div>
        ) : (
          notifications.map((n) => (
