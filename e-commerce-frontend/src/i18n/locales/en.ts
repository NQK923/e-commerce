export const en = {
  ...
  admin: {
    ...
    refresh: "Refresh",
    failed_outbox: "Failed Async Events (Outbox)",
    failed_outbox_desc: "Monitor and retry events that failed to process or reached dead letter status.",
    type: "Type",
    ...
    actions: "Actions",
    no_failed_events: "No failed events found. System is healthy.",
    retry: "Retry",
    toast: {
      load_failed: "Failed to load outbox events",
      retry_queued: "Event queued for retry",
      retry_failed: "Failed to retry event",
    }
  },
};
